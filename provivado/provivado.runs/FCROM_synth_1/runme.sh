...
HD_PWD='D:/GradeFour/FPGA-1/project/3layerCNN/provivado/provivado.runs/FCROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FCROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FCROM.tcl
