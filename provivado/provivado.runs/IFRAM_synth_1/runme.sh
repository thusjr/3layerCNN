...
HD_PWD='D:/GradeFour/FPGA-1/project/3layerCNN/provivado/provivado.runs/IFRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IFRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IFRAM.tcl
