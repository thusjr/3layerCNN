...
#
# Generated by export_simulation on Thu Jan 07 21:52:21 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './FCROM.sh' script.
...
./FCROM.sh -noclean_files

For more information on the script, please type './FCROM.sh -help'.
